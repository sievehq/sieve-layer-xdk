...
import layer, { layerClient, LayerReactComponents, Layer } from '../../get-layer';
...
const { Notifier, ConversationList, ConversationView, SendButton, FileUploadButton, MenuButton } = LayerReactComponents;
