  ...
  methods: {
    ...
    onAfterCreate: function onAfterCreate() {
      ...
      if (dateFormat && this.nodes.date) {
        Object.keys(dateFormat).forEach(function (formatName) {
          _this.nodes.date[formatName + 'Format'] = dateFormat[formatName];
        });
      }
    },
    ...
    onRender: function onRender() {
      try {
        ...
        _utils.logger.error('layer-message-item.render(): ', err);
      }
    },
    ...
    onRerender: function onRerender() {
      ...
      this.toggleClass(statusPrefix + '-read-by-all', readStatus === _constants2.default.RECIPIENT_STATE.ALL);
      this.toggleClass(statusPrefix + '-read-by-some', readStatus === _constants2.default.RECIPIENT_STATE.SOME);
      this.toggleClass(statusPrefix + '-read-by-none', readStatus === _constants2.default.RECIPIENT_STATE.NONE);

      this.toggleClass(statusPrefix + '-delivered-to-all', deliveryStatus === _constants2.default.RECIPIENT_STATE.ALL);
      this.toggleClass(statusPrefix + '-delivered-to-some', deliveryStatus === _constants2.default.RECIPIENT_STATE.SOME);
      this.toggleClass(statusPrefix + '-delivered-to-none', deliveryStatus === _constants2.default.RECIPIENT_STATE.NONE);
