...
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "Kill Arthur", "event": "kill-arthur" }]
});
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "Kill Arthur", "event": "kill-arthur" }, { "type": "action", "text": "Give Holy Grail", "event": "grant-grail" }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "Kill Arthur, all his friends, his horse and his dog", "event": "open-url", data: { url: "http://docs.layer.com" } }, { "type": "action", "text": "Give Holy Grail", "event": "open-url", data: { url: "http://layer.com" } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "Open Url", "event": "open-url" }, { "type": "action", "text": "Open File", "event": "open-file" }],
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }] }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
model = new ButtonModel({
  buttons: [{
    "type": "choice",
    "choices": [{ "text": "\uD83D\uDC4D", "id": "like" }, { "text": "\uD83D\uDC4E", "id": "dislike" }, { "text": "\uD83D\uDC4C", "id": "ok" }]
  }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], data: { responseName: "satisfaction" } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], "data": { allowReselect: true, name: 'Liking Layer' } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], "data": { preselectedChoice: 'dislike', allowReselect: true } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], "data": { allowDeselect: true } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], "data": { allowMultiselect: true } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
...
ButtonModel = Layer.Core.Client.getMessageTypeModelClass('ButtonsModel');
model = new ButtonModel({
  buttons: [{ "type": "action", "text": "open layer", event: 'open-url', data: { url: 'https://layer.com' } }, { "type": "choice", "choices": [{ "text": "like", "id": "like", "tooltip": "like" }, { "text": "dislike", "id": "dislike", "tooltip": "dislike" }], "data": { "responseName": "satisfaction", allowReselect: true } }, { "type": "choice", "choices": [{ "text": "like 2", "id": "like", "tooltip": "like" }, { "text": "dislike 2", "id": "dislike", "tooltip": "dislike" }], "data": { "responseName": "satisfaction2", allowReselect: true } }]
});
model.send({ conversation: $("layer-conversation-view").conversation });
