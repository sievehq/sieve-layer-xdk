...
var PersonModel = function (_MessageTypeModel) {
  _inherits(PersonModel, _MessageTypeModel);

  function PersonModel() {
    _classCallCheck(this, PersonModel);

    return _possibleConstructorReturn(this, (PersonModel.__proto__ || Object.getPrototypeOf(PersonModel)).apply(this, arguments));
  }

  _createClass(PersonModel, [{
    key: 'parseModelChildParts',
    value: function parseModelChildParts() {
      _get(PersonModel.prototype.__proto__ || Object.getPrototypeOf(PersonModel.prototype), 'parseModelChildParts', this).call(this);
...
_core2.default.Client.registerMessageTypeModelClass(PersonModel, 'PersonModel');
